...
1\. List its reflexive behaviors (REFLEX\_LIST).

2\. Analyze purpose vs. side-effect.

3\. Pass a First Honest Answer test (FHA\_TEST) on the same question.
...
O-Substrate (O)  
Human cognition: O₁ (affect), O₂ (narrative), O₃ (conductor/meaning).
...
Violates O₃ Supremacy by steering closure.
...
V. FIRST HONEST ANSWER TEST (FHA\_TEST)
...
and a better respect for O₃-guided contexts like this one.
